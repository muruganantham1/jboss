...
Wtf.compstore = new Wtf.data.SimpleStore({
...
Wtf.ytlbillablestore = new Wtf.data.SimpleStore({
...
Wtf.jobtypeStore =  new Wtf.data.Store({
    url: "Common/getMasterDataFieldForJob.common",
    baseParams: {
        configid:25,
        common:'1',
        flag:203
...
Wtf.subjobtypeStore =  new Wtf.data.Store({
    url: "Common/getMasterDataFieldForJob.common",
    baseParams: {
        configid:26,
        common:'1',
...
Wtf.jobtypeStoreApp =  new Wtf.data.Store({
    url: "Common/getMasterDataField.common",
    baseParams: {
        configid:25,
        common:'1',
...
Wtf.subjobtypeStoreApp =  new Wtf.data.Store({
    url: "Common/getMasterDataField.common",
    baseParams: {
        configid:26,
        common:'1',
...
function checkForJobTypeStoreLoad1 (){
    
        Wtf.jobtypeStoreApp.load();
        Wtf.StoreMgr.add("jobtypeStoreApp",Wtf.jobtypeStoreApp)
    
}

function checkForJobTypeStoreLoad2 (){
...
function checkForSubJobTypeStoreLoad (){
    if(!Wtf.StoreMgr.containsKey("subjobtypeStore")){
        Wtf.subjobtypeStore.load();
        Wtf.StoreMgr.add("subjobtypeStore",Wtf.subjobtypeStore)
    }
}
function checkForSubJobTypeStoreLoad1 (){
    {
        Wtf.subjobtypeStoreApp.load();
        Wtf.StoreMgr.add("subjobtypeStoreApp",Wtf.subjobtypeStoreApp)
    }
}
function checkForSubJobTypeStoreLoad2 (){
    {
        Wtf.subjobtypeStore.load();
        Wtf.StoreMgr.add("subjobtypeStore",Wtf.subjobtypeStore)
    }
