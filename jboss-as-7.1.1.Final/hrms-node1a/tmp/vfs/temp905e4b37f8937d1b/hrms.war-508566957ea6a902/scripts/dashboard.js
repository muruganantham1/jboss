...
var widgetArr = [WtfGlobal.getLocaleText("hrms.Dashboard.Alerts")];
...
//    }
    ...
    if(panelArr[0]!==undefined){
        panelArr[0].config1[0].paramsObj.grouper = "dashboard";            
        panelArr[0].config1[0].paramsObj.firequery = "1";           
        Wtf.getCmp('portal_container_box1').add(createNewPanel(panelArr[0]));
		isToAppendArray[0]=0;
    }
    Wtf.getCmp('portal_container').doLayout();
