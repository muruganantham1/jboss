...
function openDownloadWindow(fileName,isDownlodable,folderName ){
    ...
    if(isDownlodable != false){
       ...
       document.getElementById("downloadframe").src = url;
        ...
        Wtf.Msg.alert("Error", "You don't not have permission to access <b>"+fileName+"</b>");
    }
}
...
function createWidget(ix){
    widgetcount--;
    if(widgetcount>1){
        titleSpan.innerHTML = '<span><span style="float:left;">Add Dashboard Widgets</span><span>'+widgetcount +" Widgets</span></span>";
    }else{
        titleSpan.innerHTML = '<span><span style="float:left;">Add Dashboard Widgets</span><span>'+widgetcount +" Widget</span></span>";
    }
	var count = 0
	var lowCountCol = 1;
	var lowCount = 1;
...
var widgetArr = [];
//var widgetArr = ["Updates","Alerts","Links"];
...
//            draggable:true,
//            border:true,
//            title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Updates <a href='#' id='refreshiconupdates' title='Loading...' onclick='reloadUpdates();' class='refreshWidgets'></a></div>",
...
//    draggable:true,
//    border:true,
//    title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Alerts <a href='#' id='refreshiconalerts' title='Loading...' onclick='reloadAlerts();' class='refreshWidgets'></a></div>",
//    tools: getToolsArray('jspfiles/rss.jsp?i=my_workspaces&id=' + loginid)
//});
//panelArr.push({
//            config1:[{
...
//            draggable:true,
//            border:true,
//            title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Links</div>",
//            tools: getToolsArray('jspfiles/rss.jsp?i=my_workspaces&id=' + loginid)
//});
////}
...
//                                "<div style='padding-left:15px; background:transparent no-repeat scroll 0 0;'>{desc}</div>" +
			...
			draggable:true,
			border:true,
			title: "<div wtf:qtip=\""+WtfGlobal.getLocaleText("hrms.Dashboard.Clickdragandplacewidgetanywhereonthedashboard")+"\">Administration</div>",
			id : "dash_adminwidget",
...
//			draggable:true,
//			border:true,
//			title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Recruitment Management</div>",
//			id : "dash_recruit",
//			tools: getToolsArray('jspfiles/rss.jsp?i=announcements&u=' + loginid)
//});
//}
...
//                                "<div style='padding-left:15px; background:transparent no-repeat scroll 0 0;'>{desc}</div>" +
			...
			draggable:true,
			border:true,
			title: "<div wtf:qtip=\""+WtfGlobal.getLocaleText("hrms.Dashboard.Clickdragandplacewidgetanywhereonthedashboard")+"\">Payroll</div>",
			id : "dash_payroll",
			tools: getToolsArray('jspfiles/rss.jsp?i=announcements&u=' + loginid)
});
}
...
//			draggable:true,
//			border:true,
//			title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Timesheet Management</div>",
//			id : "dash_timesheet",
//			tools: getToolsArray('jspfiles/rss.jsp?i=announcements&u=' + loginid)
//});
//}
...
//			draggable:true,
//			border:true,
//			title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Performance Appraisal</div>",
//			id : "dash_performance",
//			tools: getToolsArray('jspfiles/rss.jsp?i=announcements&u=' + loginid)
//});
//}
...
signoutLinks +='<a href="#" style="color:#083772" onclick="javascript:signout_gmail();">Signout</a>';
...
var mainLM=new Wtf.LoadMask(mainPanel.el.dom,{msg:"Loading Widget Thumbnails..."});
mainLM.show();
Wtf.Ajax.requestEx({
//    url:Wtf.req.base + 'widget.jsp',
    ...
    var _col1=[];
    var index=0;
    res = eval('({\"col1\":[{\"id\":\"dash_adminwidget\"}],\"col3\":[],\"col2\":[]})');
...
titleSpan.innerHTML = "Add Dashboard Widgets";
...
Wtf.QuickTips.register({
    ...
    trackMouse: true,
    text: 'Click to expand Dashboard Widget'
});
...
function reloadUpdates(){//refreshiconspan
    ...
    document.getElementById("refreshiconupdates").title='Loading...';
...
function reloadAlerts(){//refreshiconspan
    ...
    document.getElementById("refreshiconalerts").title='Loading...';
