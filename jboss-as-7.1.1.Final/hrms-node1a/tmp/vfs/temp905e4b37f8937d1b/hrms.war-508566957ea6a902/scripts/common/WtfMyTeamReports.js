...
Wtf.common.WtfMyTeamReports = function(config){
    Wtf.common.WtfMyTeamReports.superclass.constructor.call(this,config);
};

Wtf.extend(Wtf.common.WtfMyTeamReports,Wtf.Panel,{
 onRender : function(config){
     Wtf.common.WtfMyTeamReports.superclass.onRender.call(this,config);
    ...
    this.auditStore = new Wtf.data.Store({
            ...
            url:"Common/Reports/getMyTeamReportData.common"           
        }),
...
//            this.quickPanelSearch.StorageChanged(store);
        ...
        resetHandler: function() {
          ...
          exportHandler: function() {
            ...
            var A = "Common/Reports/exportMyTeamReportData.common?"
