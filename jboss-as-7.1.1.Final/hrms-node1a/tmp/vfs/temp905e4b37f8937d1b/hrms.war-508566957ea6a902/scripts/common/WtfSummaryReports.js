/**
 * */
Wtf.common.WtfSummaryReports = function(config){
    Wtf.common.WtfSummaryReports.superclass.constructor.call(this,config);
};

Wtf.extend(Wtf.common.WtfSummaryReports,Wtf.Panel,{
 onRender : function(config){
     Wtf.common.WtfSummaryReports.superclass.onRender.call(this,config);
    ...
    this.auditStore = new Wtf.data.Store({
            ...
            url:"Common/Reports/getSummaryReportData.common"           
        }),
...
//            this.quickPanelSearch.StorageChanged(store);
        ...
        resetHandler: function() {
          ...
          exportHandler: function() {
            ...
            var A = "Common/Reports/exportSummaryReportData.common?"
