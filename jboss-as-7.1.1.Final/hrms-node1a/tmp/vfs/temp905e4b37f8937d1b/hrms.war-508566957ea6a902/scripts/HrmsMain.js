...
//Reports module
function reports(){
    var panel = Wtf.getCmp("reports");
    if(panel==null){
        panel = new Wtf.common.WtfReports({
            layout : "fit",
            title:"<div wtf:qtip='"+WtfGlobal.getLocaleText("hrms.administration.reports.tooltip")+"'>"+WtfGlobal.getLocaleText("hrms.administration.reports")+"</div>",//'<div wtf:qtip="Helps you to keep a track of all user activities performed on the system and also locate their place of occurrence through the IP Address.">Audit Trail</div>',
            border : false,
            id : "reports",
            iconCls:getTabIconCls(Wtf.etype.hrmsreports),
            closable: true
        });
        Wtf.getCmp('as').add(panel);
    }
...
function summaryreports(){
    var panel = Wtf.getCmp("summaryreports");
    if(panel==null){
        panel = new Wtf.common.WtfSummaryReports({
            layout : "fit",
            title:"<div wtf:qtip='"+WtfGlobal.getLocaleText("hrms.administration.reports.tooltip")+"'>"+WtfGlobal.getLocaleText("hrms.administration.reports.summaryreport")+"</div>",//'<div wtf:qtip="Helps you to keep a track of all user activities performed on the system and also locate their place of occurrence through the IP Address.">Audit Trail</div>',
            border : false,
            id : "summaryreports",
            iconCls:getTabIconCls(Wtf.etype.hrmsreports),
            closable: true
...
function myteamreports(){
    var panel = Wtf.getCmp("myteamreports");
    if(panel==null){
        panel = new Wtf.common.WtfMyTeamReports({
            layout : "fit",
            title:"<div wtf:qtip='"+WtfGlobal.getLocaleText("hrms.administration.reports.tooltip")+"'>"+WtfGlobal.getLocaleText("hrms.administration.reports.myteamreport")+"</div>",//'<div wtf:qtip="Helps you to keep a track of all user activities performed on the system and also locate their place of occurrence through the IP Address.">Audit Trail</div>',
            border : false,
            id : "myteamreports",
            iconCls:getTabIconCls(Wtf.etype.hrmsreports),
            closable: true
...
function myreports(){
    var panel = Wtf.getCmp("myreports");
    if(panel==null){
        panel = new Wtf.common.WtfMyReports({
            layout : "fit",
            title:"<div wtf:qtip='"+WtfGlobal.getLocaleText("hrms.administration.reports.tooltip")+"'>"+WtfGlobal.getLocaleText("hrms.administration.reports.myreport")+"</div>",//'<div wtf:qtip="Helps you to keep a track of all user activities performed on the system and also locate their place of occurrence through the IP Address.">Audit Trail</div>',
            border : false,
            id : "myreports",
            iconCls:getTabIconCls(Wtf.etype.hrmsreports),
            closable: true
...
/**enable or disable approve/reject button */
function enableDisableButtonTimesheet(buttonid,GridStore,GridSm){
    //Rajesh.Babu
    GridSm.on("selectionchange",function(){
        changeEnableTimesheet(buttonid,GridSm);
    },this);
...
/**Enable and disable approve/reject buttons*/
function changeEnableTimesheet(buttonid,GridSm){
    //rajesh.babu
    var selRec=GridSm.getSelections();
    var flag=0;
    if(selRec.length==1)
...
function timesheethistory()
{
    timesheetmanagement();
    var main=Wtf.getCmp("timesheetmanage");
    var vtdemoTab=Wtf.getCmp("timesheethistory");
    if(vtdemoTab==null)
    {
        vtdemoTab=new Wtf.timesheethistory({
            id:"timesheethistory",
            title:"<div wtf:qtip='"+WtfGlobal.getLocaleText("hrms.Dashboard.TimesheetHistory.tooltip")+"'>"+WtfGlobal.getLocaleText("hrms.Dashboard.TimesheetHistory")+"</div>",//"<div wtf:qtip='Allows the administrator/ manager to review and approve submitted time sheets of his employees.'>View TimeSheets</div>",
            layout:'fit',
            border:false,
//            startdate:startdate,
            //closable:true,
...
function timer1(employeeId){
	//alert('ok');
	//alert(employeeId);
	//alert('http://10.28.26.104:8080/folklore/summit_login.jsp?id='+employeeId);
	window.open('http://10.28.26.104:8080/folklore/summit_login.jsp?id='+employeeId,'mywindow')
}
	...
	//alert(employeeId);
	//alert('http://10.28.26.104:8080/folklore/summit_login.jsp?id='+employeeId);
	window.open('showjob.usr','mywindow','width=700,height=500')
}
