...
Wtf.extend(Wtf.timesheetemp,Wtf.Panel,{
    ...
    onRender: function(config) {
    	//alert("onRender "+this.viewtimesheet);
...
//            readOnly:true,
        ...
        this.jobtypeStoreTime =  new Wtf.data.Store({
            url: "Common/getMasterDataFieldForJobNew.common",
            baseParams: {               
                flag:26
            },
            pruneModifiedRecords:true,
        ...
        this.subjobtypeStoreTime =  new Wtf.data.Store({
            url: "Common/getMasterDataFieldForJobNew.common",
            baseParams: {
            	flag:26
            },
        ...
        if(!jobtypeflag){
            ...
            Wtf.StoreMgr.add("jobtypeStoreTime",this.jobtypeStoreTime)
            
            this.jobtext = new Wtf.form.ComboBox({
                store:this.jobtypeStoreTime,
                displayField:'name',
                valueField:'id',
                scope:this,
                mode:'local',
        ...
        if(!subjobtypeflag){
            ...
            Wtf.StoreMgr.add("subjobtypeStoreTime",this.subjobtypeStoreTime)
		
		// alert('combo');
			this.subjobtext = new Wtf.form.ComboBox({
                store:this.subjobtypeStoreTime,
                displayField:'name',
                valueField:'id',
                scope:this,
                mode:'local',
        ...
        this.fromdate.on("render",function(){
        	//alert('this.viewstdate '+this.viewstdate);
            if(this.viewstdate)
            {
        ...
        
		{
            ...
            editor: (!this.viewtimesheet)?this.subjobtext:"",
            align:'center'
        },
        {
        ...
        this.jobgrid = new Wtf.grid.EditorGridPanel({
            ...
            this.fromdate,'-',(WtfGlobal.getLocaleText("hrms.timesheet.todate")+":"),this.todate,'-',this.addbutton,'-', this.savejobs,'-',this.submitjobs,'-',this.deletejobs//'To Date:',this.todate,this.setbutton,'-',this.addbutton,'-', this.savejobs,'-',this.submitjobs,'-',this.deletejobs
            ],
            cm: this.cm1,
            sm: this.sm
        });
    ...
    defaultValueAssignFunction:function(e){
    	//alert('defaultValueAssignFunction');
	var hours;
...
//                this.jobstore.data.items[e.row].set('col7',hours);
    ...
    changegridheader: function(){
    	//alert("changegridheader "+this.viewtimesheet);
        this.jobgrid.enable();
        ...
        //alert('stdate '+stdate+' enddate '+this.todate.getValue());
        this.jobtypeStoreTime.load({
	            params:{
            	 configid:25,
                 isFull:'y',
    ...
    gridcalculation:function(isSubmittedFlag){
        ...
        // for(i=0;i<modifiedwork.length;i++)
        {
            ...
            if(this.jobstore.getAt(i).get('subjobtype')=="")
                // if(modifiedwork[i].get('jobtype')=="")
                {
