...
*/
Wtf.timesheethistory=function(config){

    Wtf.timesheethistory.superclass.constructor.call(this,config);
}
Wtf.extend(Wtf.timesheethistory,Wtf.Panel,{
    initComponent:function(config){
        Wtf.timesheethistory.superclass.initComponent.call(this,config);
    },
    onRender: function(config) {
       Wtf.timesheethistory.superclass.onRender.call(this, config);
...
//            url:Wtf.req.base + "hrms.jsp",
            url: "Timesheet/AllTimesheetHistory.ts",
...
//          viewbtns.push(this.setbutton);
...

        {
            ...
            renderer:function(a,b,c){
                if(c.get('status')==0){
                    return WtfGlobal.getLocaleText("hrms.common.status.saved");
        ...
        enableDisableButton("viewButtonHistory",this.timestore,this.sm);
        enableDisableButtonTimesheet("approveButtonHistory",this.timestore,this.sm);
        enableDisableButtonTimesheet("rejectButtonHistory",this.timestore,this.sm);       
 ...
 /*       this.sm.on("selectionchange",function(){
    ...
    approvefunc:function(action){
        ...
        Wtf.Ajax.requestEx({
//          url:Wtf.req.base + "hrms.jsp",
            url: "Timesheet/historyTimesheetsApproval.ts",
          params: {
                flag:28,
