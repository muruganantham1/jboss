...
Wtf.extend(Wtf.AddEditMasterData,Wtf.Window,{
    ...
    GetAddEditForm:function (){
        ...
        if(this.configid==21) {//Component Sub type
            ...
            function getISActiveValue(param1){
            	if(param1 == 1){
            		return 'Yes';
            	} else {
            		return 'No';
            ...
            this.GlidField=new Wtf.ux.TextField({
            	fieldLabel:WtfGlobal.getLocaleText("hrms.timesheet.glid")+"*",
            	width:200,
            	name:"glid",
            	maxLength:5,
            	value:(this.action == "Edit")?this.rec.get("glid"):""
            });   
           
            
            this.IsActiveField=new Wtf.form.ComboBox({
            	fieldLabel:WtfGlobal.getLocaleText("hrms.timesheet.isActive")+"*",
            	 hiddenName:'isActive',
                 store:isActiveStore,
                 valueField:'a_code',
                 ...
                 width: 200,                
                 forceSelection: true,
                 value:(this.action == "Edit")?this.rec.get("isActive"):1
