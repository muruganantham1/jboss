...
Wtf.extend(Wtf.TimesheetReport,Wtf.Panel,{
    ...
    onRender: function(config) {
        ...
        { name:'jobtype'},{ name:'jobtypename'},{ name:'subjobtype'},{ name:'subjobtypename'},{name:'col1'},{name:'col2'},{name:'col3'},{name:'col4'},{name:'col5'},{ name:"col6"},{name:"col7"},{name:'colid1'},{name:'colid2'},{name:'colid3'},
...
//            url:Wtf.req.base + "hrms.jsp",
       ...
       {
            header: WtfGlobal.getLocaleText("hrms.timesheet.project"),
            width:200,
            pdfwidth:60,
            sortable: true,
        ...
        {
            header: WtfGlobal.getLocaleText("hrms.timesheet.activity"),
            width:200,
            pdfwidth:60,
            sortable: true,
...
//            url:"Common/Export/.common"
    ...
    changegridheader: function(){        
        ...
        this.cm1.setColumnHeader(3,myDate.format('D d M Y'));
        for(i=3;i<6;i++)
        {
            myDate.setDate(myDate.getDate()+1);
            this.dateArray.push(myDate.format('Y-m-d'));
