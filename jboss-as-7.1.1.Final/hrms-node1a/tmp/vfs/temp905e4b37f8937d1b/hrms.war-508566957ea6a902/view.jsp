...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title id="Deskerahrmstitle">YTLC HRMS</title>
        <link rel="icon" href="http://www.xchanging.com/favicon.ico" type="image/x-icon">
...
<!-- /css -->
		<link rel="shortcut icon" href="http://www.xchanging.com/favicon.ico"/>
	</head>
	<body>
		<div id="loading-mask" style="width:100%;height:100%;background:#EEE;position:absolute;z-index:20000;left:0;top:0;">&#160;</div>
		<div id="loading">
...
<!-- js -->
		...
		<script type="text/javascript" src="scripts/common/WtfReports.js?v=3"></script>
		<script type="text/javascript" src="scripts/common/WtfSummaryReports.js?v=3"></script>
		<script type="text/javascript" src="scripts/common/WtfMyTeamReports.js?v=3"></script>
		<script type="text/javascript" src="scripts/common/WtfMyReports.js?v=3"></script>
		...
		<script type="text/javascript" src="scripts/common/MultiGrouping.js?v=3"></script>
                <script type="text/javascript" src="scripts/common/crmcommon/WtfCommonFunction.js"></script>
                ...
                <script type="text/javascript" src="scripts/common/UserManagement.js"></script>
		...
		<script type="text/javascript" src="scripts/DeskeraHRMS/adminMaster/AddEditMaster.js?v=3"></script>
                ...
                <script type="text/javascript" src="scripts/DeskeraHRMS/adminMaster/AddProject.js?v=3"></script>
		...
		<script type="text/javascript" src="scripts/PayrollDateLeaveWindow.js"></script>
		...
		<script type="text/javascript" src="scripts/DeskeraHRMS/Timesheet/timesheetemployee.js"></script>
		<script type="text/javascript" src="scripts/DeskeraHRMS/Timesheet/timesheetemployee.js"></script>
		<script type="text/javascript" src="scripts/DeskeraHRMS/Timesheet/viewtimesheets.js"></script>
		<script type="text/javascript" src="scripts/DeskeraHRMS/Timesheet/timesheethistory.js"></script>
...
<!-- html -->
		<div id="header" style="position: relative;">
			...
			<div id="userinfo" class="userinfo">
				<span id="whoami"></span><br /><a id="whoami_sign_out" href="#" onclick="signOut('signout');"></a>&nbsp;&nbsp;<a id="whoami_show_person_profile" href="#" onclick="showPersnProfile();"></a>&nbsp;&nbsp;<a id="myProfile" href=# onclick='myProfile()'></a>&nbsp;&nbsp;<a  href="#"  id="organisationlink" onclick="loadOrganizationPage();"></a>
			</div>
			<div id="serchForIco"></div>
			<div id="searchBar"></div>
			<div id="shortcuts" class="shortcuts">
                            <div id="shortcutmenu1"style="float:right !important;position: relative;display:inline;"></div>
			</div>
		</div>
